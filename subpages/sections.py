...
def show_section1():
    ...
    st.components.v1.html(
        f"<iframe title='Air Quality visualisation with cities' width='100%' height='400px' "
...
def show_section3():
    st.title("how Traffic and season effect on Air Quality?")
    st.components.v1.html(
    ...
    **This analysis enables us to better understand and mitigate the effects of traffic on air pollution!** 🚗💨
    ...
    """)
def show_section4():
    st.title("AQI forecasted...")
    st.subheader("for next 5 years")
    st.components.v1.html(
            f"<iframe title='pollutant details with cities' width='100%' height='400px' "
